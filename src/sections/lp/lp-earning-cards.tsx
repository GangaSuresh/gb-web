          ...
          >
            <Box
              sx={{
                ...
                transform: `translateX(-${currentSlide * 100}%)`, // Fixed: Each slide takes 100% width
              }}
            >
              {earnMethods.map((method, index) => (
                <Box
                  key={index}
                  sx={{
                    minWidth: '100%', // Fixed: Each slide container takes full width
                    display: 'flex',
                ...
                >
                  <Card
                    sx={{
                      ...
                      height: '236px', // Fixed height for the card
                      borderRadius: '16px',
