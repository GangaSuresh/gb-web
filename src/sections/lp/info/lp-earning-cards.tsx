...
const LPEarningMethods: React.FC<LPEarningMethodsProps> = ({ earnMethods, isMobile, lpicon }) => {
  ...
  const cardsPerSlide = 2; // Changed to show 2 cards
            ...
            {Array.from({ length: totalSlides }).map((_, slideIndex) => (
              <Box
                ...
                sx={{
                  ...
                  gap: 1.5, // Gap between the two cards
                  px: 1
                }}
              >
                {earnMethods
                  ...
                  .map((method, cardIndex) => (
                    <Card
                      ...
                      sx={{
                        width: '160px', // Slightly reduced to fit 2 cards
                        height: '236px',
                        borderRadius: '16px',
                    ...
                    >
                      ...
                      <Typography sx={{ 
                        ...
                        mt: '0.5rem', 
                        mb: '0.8rem',
                        fontSize: '0.9rem' // Slightly smaller text for better fit
                      }}>
                        {method.title}
                      </Typography>
                ...
                {/* Add empty placeholder if odd number of cards on last slide */}
                {slideIndex === totalSlides - 1 && 
                 earnMethods.length % cardsPerSlide === 1 && (
