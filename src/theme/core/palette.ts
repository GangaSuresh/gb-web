...
export type ColorType = 'primary' | 'secondary' | 'info' | 'success' | 'warning' | 'error' | 'backgroundColor';
...
// Background
export const backgroundColor = createPaletteChannel(COLORS.backgroundColor);
